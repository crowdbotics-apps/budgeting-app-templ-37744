...
## Project Structure
    ...
    ├── finance_app_templat_37744  # Django project configurations
...
1. Clone this repo and `cd finance_app_templat_37744`
...
2. Clone this repo and `cd finance_app_templat_37744`
